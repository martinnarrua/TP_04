...
{
    [TestClass]
    public class UserFullNameAscendingCaseSensitiveComparerTest
    {

        [TestMethod]
        public void Compare_With_ramiro_Ramiro_ReturnsMenor()
        {
            ...
            IComparer<Usuario> lComparer = new UserFullNameAscendingCaseSensitiveComparer();
